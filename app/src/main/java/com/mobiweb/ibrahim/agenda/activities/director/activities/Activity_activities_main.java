...
public class Activity_activities_main extends ActivityBase {
    ...
    private void init(){
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(((Agenda)getApplication()).getCashedType().matches(AppConstants.LOGIN_DIRECTION))
                    startActivity(new Intent(Activity_activities_main.this,Activity_direction_home.class));
                else
                    Activity_activities_main.super.onBackPressed();
            }
        });
      ...
      //  toolbarTitle.setText(getIntent().getStringExtra(AppConstants.CLASS_NAME));
        ...
        llAddActivity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(Activity_activities_main.this,Activity_add_activities.class);
                startActivity(i);
            }
        });
        ...
        llViewActivity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(Activity_activities_main.this,Activity_view_activities.class);
               startActivity(i);
            }
        });
