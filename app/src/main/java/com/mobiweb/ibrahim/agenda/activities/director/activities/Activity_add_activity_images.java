...
public class Activity_add_activity_images extends Activity implements RVOnItemClickListener{
   ...
   @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Activity_add_activity_images.super.onBackPressed();
            }
        });
    ...
    private void init() {
        ...
        ivRight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_add_activity_images.this,Activity_direction_home.class));
            }
        });
    ...
    private void popUpMessage(final boolean isSuccess){
        ...
        btOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(isSuccess) {
                    startActivity(new Intent(Activity_add_activity_images.this,Activity_view_activities.class));
