...
public class Activity_view_schedule_teacher extends ActivityBase {
    ...
    private CustomTextView ctvPickText;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Activity_view_schedule_teacher.super.onBackPressed();
            }
        });
        ctvPickText.setText("Press here to Pick Teacher Schedule");
        getSchedule();
    ...
    private void init() {
        ...
        ctvPickText=(CustomTextView)findViewById(R.id.ctvPickText);
        ...
        ivRight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_view_schedule_teacher.this,Activity_direction_home.class));
            }
        });
    ...
    private void getVideoIntent(){
        ...
        teacher_id=AppHelper.getTeacherId();


        //   Toast.makeText(getApplication(),class_id+" aa "+class_section_id+ " aa "+class_name,Toast.LENGTH_LONG).show();
       try {
           toolbarTitle.setText(AppHelper.getTeacher_name());
       }catch (Exception e){
           toolbarTitle.setText(getText(R.string.schedual_teacher));
       }
    ...
    private void getSchedule() {
        ...
        Call call1 = RetrofitClient.getClient().create(RetrofitInterface.class)
                .getScheduleTeacher(new JsonParameters(2,teacher_id));
    ...
    private void addSchedule() {
        ...
        RequestBody req_id_teacher = RequestBody.create(MediaType.parse("text/plain"),teacher_id);
